...
UNREALROOTPATH = /home/cx9ps3/UnrealEngine
GAMEPROJECTFILE =/home/cx9ps3/Albanian-Accident/Cybernosis.uproject

TARGETS = \
	Cybernosis-Linux-Debug  \
	Cybernosis-Linux-DebugGame  \
	Cybernosis-Linux-Test  \
	Cybernosis-Linux-Shipping  \
	Cybernosis \
	CybernosisEditor-Linux-Debug  \
	CybernosisEditor-Linux-DebugGame  \
	CybernosisEditor-Linux-Test  \
	CybernosisEditor-Linux-Shipping  \
	CybernosisEditor \
...
Cybernosis-Linux-Debug:
	 $(PROJECTBUILD) Cybernosis Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

Cybernosis-Linux-DebugGame:
	 $(PROJECTBUILD) Cybernosis Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

Cybernosis-Linux-Test:
	 $(PROJECTBUILD) Cybernosis Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

Cybernosis-Linux-Shipping:
	 $(PROJECTBUILD) Cybernosis Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

Cybernosis:
	 $(PROJECTBUILD) Cybernosis Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

CybernosisEditor-Linux-Debug:
	 $(PROJECTBUILD) CybernosisEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

CybernosisEditor-Linux-DebugGame:
	 $(PROJECTBUILD) CybernosisEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

CybernosisEditor-Linux-Test:
	 $(PROJECTBUILD) CybernosisEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

CybernosisEditor-Linux-Shipping:
	 $(PROJECTBUILD) CybernosisEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

CybernosisEditor:
	 $(PROJECTBUILD) CybernosisEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
